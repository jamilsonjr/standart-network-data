...
class Extractor: 
    def create_peers_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.Peer objects.
        """
    ...
    def create_vehicles_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.Vehicle objects.
        """
    ...
    def create_charging_stations_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.ChargingStation objects.
        """
    ...
    def create_generators_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.Generator objects.
        """
    ...
    def create_storages_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.Storage objects.
        """
    ...
    def create_loads_list(self, df):
        ...
        Returns:
            list: Returns a list of classes.Load objects.
        """
